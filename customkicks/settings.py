...
SECRET_KEY = 'django-insecure-afijkvhk*m%=48t6tlh860o1jlmvr*tzq=x-iccqdnaqr48t72'
...
WSGI_APPLICATION = 'customkicks.wsgi.application'
...
STATIC_URL = '/static/'  # Ensure you include the leading slash
